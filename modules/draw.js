...
draw.drawShape = function(c,x,y,shape){
  ...
  draw.drawShapeKind = function(c,s,x,y,stroke,opacity,color,shadow){
      ...
      switch(s.kind){
          case 'rect':
              draw.drawRect(c, s.w, s.h, s.rotation, stroke); break;
          case 'arc':
              draw.drawArc(c, s.rad,s.arcDegree,s.rotation, stroke); break;
          case 'text':
          ...
          case 'roundedRectangle':
              draw.drawRoundedRectangle(c,s.w,s.h,s.rotation,s.borderRadius,stroke)
              break
          default:
              break
      }
